...
<nav class="navbar navbar-expand-lg ">
    <div class="container align-items-baseline w-100 ">
        <a class="navbar-brand" href="#"><img src="{{asset('english/images/Final Slash Presentation-logo.png')}}" alt=""></a>
        ...
        <div class="collapse navbar-collapse mr-auto" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0  d-flex align-items-baseline">
                ...
                <li class="nav-item dropdown d-flex align-items-baseline" >
                    <a class="dropdown-item" href="#"><img src="{{asset('english/images/united-states.png')}}" alt="" class="language-img">EN</a>
                    <a class="nav-link dropdown-toggle lan-div m-0" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        
                    </a>
                    <ul class="dropdown-menu">
                        <li class="d-flex"><img src="{{asset('english/images/egypt.png')}}" alt="" class="language-img"><a class="dropdown-item"
                                href="arabic/index-ar.html">العربيه</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="col-xl-6">
                ...
                SLASH</h2>
                    ...
                    <div class="icons-group">
                        <a href=""><img src="{{asset('english/images/Group 4320.png')}}" alt=""></a>
                        <a href=""><img src="{{asset('english/images/Group 4321.png')}}" alt=""></a>
                        <a href=""><img src="{{asset('english/images/Group 4322.png')}}" alt=""></a>
                    </div>
                </div>
...
<button type="button" class="btn btn btn-floating btn-lg" id="btn-back-to-top">
    <img src="{{asset('english/images/go-up.png')}}" alt="">
</button>
<button type="button" class="btn btn btn-floating-whatsapp btn-lg">
    <a href="https://wa.link/n8a1le"><img src="{{asset('english/images/Group 4318@2x.png')}}" alt=""></a>
</button>
<div class="about" id="about-us">
    <div class="container">
        <div class="row">
            <div class="col-xl-4 photo-1 d-flex flex-column align-items-end justify-content-end mb-4 mb-xl-0">
                <img class="w-100 photo-1" src="{{asset('english/images/thisisengineering-raeng-XAAGdkSueLo-unsplash.png')}}" alt="">
            ...
            <div class="col-xl-6 content d-flex flex-column align-items-baseline justify-content-center">
                ...
                modern administrative system that equates employees with customers. We look forward to being the largest Arab company in
                this field and conquer the foreign market, according to our experience and our renewed thought always. Since the web is
                easily able to accommodate media such as audio, images and video as well as text. social sites supporting these media
                have emerged.</p>
        ...
        <div class="row">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mb-5">
                    ...
                    <div class="tab">
                        ...
                        <button class="tablinks" onclick="openTap(event, 'websiteDevelopment')">WEBSITE DEVELOPMENT</button>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row ">
                <div class="col-xl-4">
                    <div class="contact-details mb-4 mb-xl-0">
                        <p>Phone</p>
                        <a href="tel:+0201159116034">+0201159116034</a>
                        <p>Email</p>
                        <a href="">myegy2022@myegy.com</a>
                        <p>Address</p>
                        <a href="">3145 Beeghley Street Valley Mills Cairo 76689</a>
                    </div>
                </div>
                <div class="col-xl-8">
                    <form action="/action_page.php">
                        <div class="mb-3 d-flex justify-content-between side">
                            <input type="text" class="form-control w-30" placeholder="Full Name" name="name" id="name" required>
                            <input type="text" class="form-control w-40" placeholder="Email" name="email" id="email" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="Subject" name="subject" id="subject" required>
                        </div>
                        <div class="mb-3">
                            <textarea name="Message" class="form-control" placeholder="Message" id="message" cols="30" rows="4" required></textarea>
                        </div>
    ...
    <div class="container">
       <div class="footer-bg">
        <div class="row">
            <div class="col-xl-3">
                <div class="p-1">
                    <img src="{{asset('english/images/Final Slash Presentation-logo-1.png')}}" alt="">
                    <p>
                        Slash solves the cyber skills gap.Continuous on-demand security scaled by the world's most skilled ethical hackers and
                        AI technology.
                    </p>
            ...
            <div class="col-xl-3">
                <div class="p-2">
                    <ul>
                        ...
                        <li class="mb-2"><a href="">CLIENTS</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-3">
                <div class="p-3">
                    <p>building 167 street 28 – District No 5 – The 5th District – New cairo City.,cairo Governorate</p>
                    <p>Email: contact@v ulnation.net</p>
                    <p>Tel: 123.457.9012</p>
                    <p>Fax: (+20) 1159116034</p>
                    <a href=""><img src="{{asset('english/images/ic_phone_bluetooth_speaker_24px.png')}}" alt=""> 1239400</a>
                </div>
            </div>
            <div class="col-xl-3">
